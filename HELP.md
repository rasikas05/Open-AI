# Read Me First
The following was discovered as part of building this project1:

* The original package name 'com.ai.openai-api-service' is invalid and this project uses 'com.ai.openai_api_service' instead.
